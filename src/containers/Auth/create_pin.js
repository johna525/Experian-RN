...
import { MyText, Button, IconButton } from '../../components';
...
class CreatePinScreen extends React.Component {
  ...
  onCreatePin = () => {
    ...
    NavigationService.navigate('CONFIRM_PIN');
  }
  ...
  render() {
    ...
    return (
      <Container style={styles.container}>
        <MyText color={colors.text} text={I18n.t('create_pin')} textAlign="center" />
        <View style={styles.pinInput}>
          {
            Array.apply(null, { length: 6 }).map((item, index) => (
              <View key={index} style={[styles.pinPoint, { backgroundColor: index < pin.length ? colors.blue : colors.gray }]} />
            ))
          }
        </View>
...
export default connect(undefined, mapDispatchToProps)(CreatePinScreen);
